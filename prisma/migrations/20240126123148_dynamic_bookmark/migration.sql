/*
  ...
  - A unique constraint covering the columns `[userId,referenceType]` on the table `Bookmark` will be added. If there are existing duplicate values, this will fail.
  - Added the required column `bookmarkedItemId` to the `Bookmark` table without a default value. This is not possible if the table is not empty.
...
-- CreateIndex
CREATE UNIQUE INDEX "Bookmark_userId_referenceType_key" ON "Bookmark"("userId", "referenceType");
